...
const ProgressBar = ({ progressState, title, steps = 10, max = steps, toFixed = 0 }: ProgressBarProps) => {
  ...
  return (
    <div className="flex flex-col gap-3 progress-bar">
      <p className="flex justify-center text-2xl font-light tracking-wider">{title}</p>
      <div className="container">
        <div className="percentage">{progress.toFixed(toFixed)}</div>
        <div className="progress">
          <div ref={barRef} onClick={handleProgressClick} className="bar"/>
          <div style={{ width: `${progress/max*100}%` }} className="fill"></div>
          <div
